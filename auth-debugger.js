...
async function checkSupabaseConnection() {
  try {
    ...
    try {
      ...
      supabase = window.supabase || (await import('@supabase/supabase-js')).createClient(
...
async function testSignin(supabase, email = 'test.user@mixmingle.com', password = 'TestPass123!') {
  try {
