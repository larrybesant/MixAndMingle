      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-6xl font-black mb-4">
            <span className="text-orange-400 drop-shadow-[0_0_15px_rgba(251,146,60,0.8)]">
              MIX
            </span>
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Welcome to the exclusive beta test of Mix & Mingle! Help us perfect
            the ultimate DJ streaming and social platform.
          </p>
        </div>
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    Go live, webcam/audio, viewer interaction
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
            ...
            <div className="space-y-4 text-gray-300">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    Any errors, broken features, or crashes
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    Slow loading, lag, streaming problems
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    Confusing UI, missing features, suggestions
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
        ...
        <div className="text-center mt-12 text-gray-400">
          ...
          <p className="text-sm mt-2">
            Beta Version 1.0 | Build Date: {new Date().toLocaleDateString()}
          </p>
        </div>
      </div>
    </div>
