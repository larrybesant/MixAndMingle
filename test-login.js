...
async function testLogin() {
  ...
  try {
    ...
    console.log('✅ Email verification check:', {
      immediately_confirmed: data.email_verification_status?.immediately_confirmed,
      requires_verification: data.email_verification_status?.requires_verification,
  ...
  */
  ...
  console.log('   node -e "fetch(\'http://localhost:3001/api/test-email\', {method:\'POST\', headers:{\'Content-Type\':\'application/json\'}, body:JSON.stringify({email:\'your-email@gmail.com\',type:\'test\'})}).then(r=>r.json()).then(console.log)"');
}
