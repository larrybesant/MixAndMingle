...
async function simpleUserCleanup() {
  ...
  try {
    ...
    console.log(`🎉 Cleanup complete! Deleted ${deletedCount}/${profiles.length} profiles`);
    ...
    console.log('Just create a new test account - the language feature will still work!');
