...
async function testDirectSupabaseLogin(email, password) {
  ...
  if (!supabaseKey) {
    console.log('❌ Missing NEXT_PUBLIC_SUPABASE_ANON_KEY - checking .env.local...');
...
async function diagnoseLoginIssues() {
  ...
  console.log('1. Email not confirmed: Check if email verification is required');
  console.log('2. Wrong credentials: Double-check email and password');
  console.log('3. User not found: Make sure the account was created successfully');
