...
async function deleteAllUsers() {
  ...
  try {
    ...
    if (deleteError) {
      ...
      console.log('💡 This might be due to RLS policies. Trying individual deletion...');
      ...
      console.log(`🎯 Deleted ${deletedCount} out of ${profiles.length} profiles`);
    } else {
    ...
    console.log('💡 You may need to manually delete users from Supabase dashboard');
  }
}
