...
async function testLoadingIssue() {
  ...
  try {
    ...
    if (loginResponse.ok) {
      ...
      console.log(
        "1. ✅ Added better error handling to checkProfileAndRedirect function",
      );
      console.log("2. ✅ Added timeout to prevent hanging redirects");
      console.log(
        "3. ✅ Added debug logging to track where process gets stuck",
      );
      console.log(
        "4. ✅ Improved finally block to ensure loading state is cleared",
      );
      ...
      console.log(
        '4. Click "Sign In" and watch the console for debug messages',
      );
