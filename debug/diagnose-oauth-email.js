...
async function diagnoseOAuthAndEmail() {
  ...
  try {
    const response = await fetch(
      "http://localhost:3000/api/email-config-check",
    );
  ...
  try {
    const response = await fetch(
      "http://localhost:3000/api/check-email-verification",
    );
    const data = await response.json();
  ...
  console.log(
    "   - Redirect URL: https://ywfjmsbyksehjgwalqum.supabase.co/auth/v1/callback",
  );
  console.log("");
  ...
  console.log(
    "5. Add authorized redirect URI: https://ywfjmsbyksehjgwalqum.supabase.co/auth/v1/callback",
  );
  console.log("");
  ...
  console.log(
    "1. Go to: https://supabase.com/dashboard/project/ywfjmsbyksehjgwalqum/auth/templates",
  );
  ...
  console.log(
    '2. For password reset: Use "forgot password" link on login page',
  );
