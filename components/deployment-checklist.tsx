...
import { Rocket, CheckCircle, ExternalLink, Settings } from "lucide-react";
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-white/60 text-sm">
                Complete these steps to launch your MVP
              </p>
            </div>
          </div>
        ...
        <div className="mb-6 grid grid-cols-3 gap-4">
          {Object.entries(categories).map(([key, category]) => {
            ...
            return (
              <div
                key={key}
                className="bg-slate-700/30 p-4 rounded-lg text-center"
              >
        ...
        <div className="space-y-4">
          {Object.entries(categories).map(([categoryKey, category]) => {
            ...
            return (
              <div key={categoryKey}>
                <h3
                  className={`text-lg font-bold ${category.color} mb-3 flex items-center space-x-2`}
                >
                  {category.icon}
                        ...
                        <div className="flex items-start space-x-3 flex-1">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center space-x-2 mb-1">
                              <h4
                                className={`font-medium ${item.completed ? "text-green-400 line-through" : "text-white"}`}
                              >
                                {item.title}
                              </h4>
                              <Badge
                            ...
                            <p
                              className={`text-sm ${item.completed ? "text-green-300/70 line-through" : "text-white/70"}`}
                            >
                              {item.description}
                            </p>
                          </div>
