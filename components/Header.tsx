  ...
  return (
    <header className="flex items-center justify-between p-4 border-b border-purple-700 bg-black/80">
      ...
      <nav className="flex items-center gap-6">
        ...
        {user ? (
          <>
            <span className="text-purple-100 mr-4">
          ...
          <>
            ...
            <Link
              href="/auth/register"
              className="px-4 py-2 border border-purple-700 text-purple-200 rounded hover:bg-purple-700 hover:text-white transition"
            >
              Register
            </Link>
          </>
