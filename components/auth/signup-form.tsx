...
export default function SignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await signUpWithEmail(formData.email, formData.password, formData.firstName, formData.lastName, formData.username)
  ...
  return (
    <Card className="w-full max-w-md bg-white/95 backdrop-blur-md">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-2xl font-bold">Join Mix & Mingle</CardTitle>
