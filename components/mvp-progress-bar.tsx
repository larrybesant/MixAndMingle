...
export function MVPProgressBar() {
  ...
  const totalProgress = Math.round(
    features.reduce((acc, feature) => acc + feature.progress, 0) /
      features.length,
  );
      ...
      <div className="p-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-white/60 text-sm">
                Track your app completion status
              </p>
            </div>
          </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex justify-between text-sm text-white/60 mt-2">
            <span>
              {completedTasks.length} of {features.length} features complete
            </span>
          ...
          <div className="mb-6 p-4 bg-red-900/20 border border-red-500/30 rounded-lg">
            ...
            <div className="space-y-2">
              {criticalTasks.map((task) => (
                <div
                  key={task.id}
                  className="flex items-center justify-between bg-red-900/30 p-2 rounded"
                >
