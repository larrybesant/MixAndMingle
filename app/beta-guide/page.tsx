...
export default function BetaGuidePage() {
  return (
    <div className="container mx-auto max-w-4xl py-12">
      <h1 className="mb-8 text-center text-4xl font-bold">Welcome to the Beta Test!</h1>

      <Card className="mb-8">
        <CardHeader>
          <CardTitle>Getting Started</CardTitle>
          <CardDescription>Follow these steps to begin testing</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="rounded-lg bg-gray-100 p-4 dark:bg-gray-800">
            <h3 className="mb-2 font-semibold">1. Complete Your Profile</h3>
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Add your details to your profile so other testers can recognize you.
            </p>
          ...
          <div className="rounded-lg bg-gray-100 p-4 dark:bg-gray-800">
            <h3 className="mb-2 font-semibold">2. Explore Available Features</h3>
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Check out the events, streams, and chat features.
            </p>
          ...
          <div className="rounded-lg bg-gray-100 p-4 dark:bg-gray-800">
            <h3 className="mb-2 font-semibold">3. Provide Feedback</h3>
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Let us know about any bugs you find or features you'd like to see.
            </p>
            <Button asChild className="mt-2">
        ...
        <CardFooter>
          <p className="text-sm text-gray-500">Thank you for helping us test and improve our platform!</p>
        </CardFooter>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>We're already aware of these bugs</CardDescription>
        </CardHeader>
        <CardContent>
          <ul className="list-inside list-disc space-y-2">
            <li>Profile images may not upload on certain browsers</li>
            <li>Chat notifications don't always appear immediately</li>
            <li>Mobile layout issues on some Android devices</li>
            <li>Event calendar sync occasionally fails</li>
          </ul>
        </CardContent>
        <CardFooter>
          <Button variant="outline" asChild>
            <Link href="/feature-voting">Vote on New Features</Link>
          </Button>
        </CardFooter>
      </Card>
