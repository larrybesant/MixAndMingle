      ...
      <section className="flex flex-col items-center text-center mt-12 mb-12">
        ...
        <div className="w-full max-w-2xl rounded-3xl overflow-hidden shadow-2xl mb-8 relative bg-gradient-to-tr from-[#1a103a] to-[#2d1a5a]">
          <div className="h-64 md:h-80 flex items-center justify-center">
            <span className="text-2xl text-indigo-300">[Featured DJ Image]</span>
          </div>
      ...
      <section className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-gradient-to-tr from-[#1a103a] to-[#2d1a5a] p-0 overflow-hidden">
            <div className="h-40 bg-blue-900 flex items-center justify-center">[Image]</div>
            <div className="p-4">
          ...
          <Card className="bg-gradient-to-tr from-[#1a103a] to-[#2d1a5a] p-0 overflow-hidden">
            <div className="h-40 bg-pink-900 flex items-center justify-center">[Image]</div>
            <div className="p-4">
          ...
          <Card className="bg-gradient-to-tr from-[#1a103a] to-[#2d1a5a] p-0 overflow-hidden">
            <div className="h-40 bg-yellow-900 flex items-center justify-center">[Image]</div>
            <div className="p-4">
