...
export default function Head() {
  return (
    <>
      ...
      <meta name="description" content="Mix & Mingle: The social DJ streaming app for music lovers, creators, and communities. Go live, chat, and connect!" />
      <meta name="viewport" content="width=device-width, initial-scale=1" />
      <link rel="icon" href="/favicon.ico" />
      <meta property="og:title" content="Mix & Mingle – Social DJ Streaming" />
      <meta property="og:description" content="Go live, chat, and connect with DJs and music fans worldwide." />
