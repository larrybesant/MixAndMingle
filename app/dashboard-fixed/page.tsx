...
import { WorkingButton } from "@/components/ui/working-button"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-black/40 border-purple-500/30">
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  <WorkingButton
                    className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 h-16 flex-col text-white"
                    href="/rooms"
                  >
                  ...
                  <WorkingButton
                    className="bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 h-16 flex-col text-white"
                    href="/matchmaking"
                  >
                  ...
                  <WorkingButton
                    className="bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 h-16 flex-col text-white"
                    href="/go-live"
                  >
                  ...
                  <WorkingButton
                    className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 h-16 flex-col text-white"
                    href="/messages"
                  >
            ...
            <Card className="bg-black/40 border-purple-500/30">
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    { name: "House Vibes Only", dj: "DJ Sarah", listeners: 234, genre: "House", id: "room-1" },
                    { name: "Late Night Techno", dj: "DJ Mike", listeners: 156, genre: "Techno", id: "room-2" },
                    { name: "Hip-Hop Classics", dj: "DJ Alex", listeners: 89, genre: "Hip-Hop", id: "room-3" },
                  ].map((room, index) => (
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-yellow-900/20 border-yellow-500/30">
              <CardHeader>
                <CardTitle className="text-yellow-400">Button Tests</CardTitle>
              </CardHeader>
