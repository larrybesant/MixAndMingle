      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-4">
          <div className="flex items-center justify-center space-x-3">
            ...
            <h1 className="text-4xl font-bold text-white">🚨 Auth Fix Required</h1>
          </div>
        ...
        <Card className="bg-red-900/20 border-red-500/30">
          <div className="p-6">
            ...
            <div className="text-red-300 space-y-2">
              <p>❌ Authentication failing because the <code className="bg-black/50 px-2 py-1 rounded">profiles</code> table doesn't exist</p>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-slate-700/30 rounded-lg">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="text-white font-medium">Open Supabase Dashboard</h3>
                </div>
                <Button 
              ...
              <div className="p-4 bg-slate-700/30 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  In your Supabase project, click on "SQL Editor" in the left sidebar
                </p>
              </div>
              ...
              <div className="p-4 bg-slate-700/30 rounded-lg">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="text-white font-medium">Copy & Run This SQL</h3>
                </div>
              ...
              <div className="p-4 bg-slate-700/30 rounded-lg">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="text-white font-medium">Test Authentication</h3>
                </div>
                ...
                {authTestResult && (
                  <div className={`mt-3 p-3 rounded border ${
                    ...
                    <div className={`font-medium ${authTestResult.canSignup ? 'text-green-400' : 'text-red-400'}`}>
                      {authTestResult.canSignup ? '✅ Auth Fixed! You can now sign up!' : '❌ Still needs fixing'}
                    </div>
                    {authTestResult.error && (
                      <div className="text-sm mt-1 opacity-75">Error: {authTestResult.error}</div>
                    )}
                  </div>
                )}
              </div>
        ...
        <div className="text-center p-6 bg-green-900/20 border border-green-500/30 rounded-lg">
          ...
          <p className="text-green-300">
            Users will be able to create accounts, log in, and use all features of your app.
          </p>
        </div>
      </div>
    </div>
